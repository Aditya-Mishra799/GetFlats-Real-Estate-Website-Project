...
const PropertyListingsCard = ({ data }) => {
  ...
  const menuDropDownButton = <div className='absolute text-md tracking-wider font-semibold top-1 right-1 hover:bg-white p-1  rounded-full  hover:text-active-orange  cursor-pointer '
    title={'Menu'}
