    ...
    <>
      <div className="">
        <ul className="flex gap-4 overflow-scroll hidden-scrollbar my-4 px-2">
          <li
            className="flex gap-1 items-center bg-active-orange px-2 py-1 w-max text-nowrap text-white uppercase tracking-wider rounded-md cursor-pointer flex-nowrap text-xl"
            onClick={() =>
              router.push(
